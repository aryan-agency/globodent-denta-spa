  ...
  <footer className="bg-foreground text-primary-foreground/80">
    <div className="container mx-auto section-padding">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <nav className="flex flex-col gap-2 text-sm">
            ...
            <Link to="/about" className="hover:text-primary-foreground transition-colors">About Doctors</Link>
      ...
      <div className="mt-12 pt-6 border-t border-primary-foreground/10 text-center text-xs">
        <p>© {new Date().getFullYear()} Globodent Dental Spa. All rights reserved. | Best Dental Clinic in Malviya Nagar, New Delhi</p>
      </div>
    </div>
  </footer>
);
